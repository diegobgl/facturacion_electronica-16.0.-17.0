...
class SIIResumenBoletaVoucher(models.Model):
    ...
    def set_movimientos(self):
        ...
        query = [
            ...
            ('order_id.payment_ids.payment_method_id.journal_id', 'in', self.medios_de_pago.ids),
            ('order_id.payment_ids.company_id', '=', self.company_id.id),
        ]
        ...
        query = [
            ...
            ('payment_ids.payment_method_id.journal_id', 'in', self.medios_de_pago.ids),
